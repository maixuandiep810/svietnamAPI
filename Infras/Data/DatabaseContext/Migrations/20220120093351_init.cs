        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlobalCode = table.Column<string>(type: "Varchar(12)", maxLength: 12, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Core_DataTypeConsts", x => x.Id);
                    table.UniqueConstraint("AK_Core_DataTypeConsts_Name", x => x.Name);
                });

            migrationBuilder.CreateTable(
                name: "Core_DocumentTypeConsts",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Core_DocumentTypeConsts", x => x.Id);
                    table.UniqueConstraint("AK_Core_DocumentTypeConsts_Name", x => x.Name);
                });

            migrationBuilder.CreateTable(
                name: "Core_EntityTypeConsts",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Core_EntityTypeConsts", x => x.Id);
                    table.UniqueConstraint("AK_Core_EntityTypeConsts_Name", x => x.Name);
                });

            migrationBuilder.CreateTable(
                name: "Eav_EavAttributeGroupConsts",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Eav_EavAttributeGroupConsts", x => x.Id);
                    table.UniqueConstraint("AK_Eav_EavAttributeGroupConsts_Name", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Core_EntityStatusConsts", x => x.Id);
                    table.UniqueConstraint("AK_Core_EntityStatusConsts_Name", x => x.Name);
                    table.ForeignKey(
                        name: "FK_Core_EntityStatusConsts_Core_EntityTypeConsts_EntityTypeId",
                        column: x => x.EntityTypeId,
                        principalTable: "Core_EntityTypeConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Auth_Users_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Core_Documents_Core_DocumentTypeConsts_DocumentTypeId",
                        column: x => x.DocumentTypeId,
                        principalTable: "Core_DocumentTypeConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Core_Documents_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Eav_EavAttributes_Core_DataTypeConsts_DataTypeId",
                        column: x => x.DataTypeId,
                        principalTable: "Core_DataTypeConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Eav_EavAttributes_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Eav_EavAttributes_Core_EntityTypeConsts_EntityTypeId",
                        column: x => x.EntityTypeId,
                        principalTable: "Core_EntityTypeConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Eav_EavAttributes_Eav_EavAttributeGroupConsts_EavAttributeGroupId",
                        column: x => x.EavAttributeGroupId,
                        principalTable: "Eav_EavAttributeGroupConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Eav_EavAttributes_Eav_EavAttributeGroupConsts_EavAttributeGroupId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseImageId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Catalog_GlobalProductCategories_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Eav_EavAttributeValues_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Core_Addresses_Core_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Core_Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Core_Addresses_Core_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Core_Districts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Core_Addresses_Core_Provinces_ProvinceId",
                        column: x => x.ProvinceId,
                        principalTable: "Core_Provinces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Catalog_Manufacturers_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Catalog_Suppliers_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnlineStores_Stores_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Catalog_Products_Core_Countries_CountryOfOriginId",
                        column: x => x.CountryOfOriginId,
                        principalTable: "Core_Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Catalog_Products_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Logistics_ShippingTableRates_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnlineOrders_Orders_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnlineOrders_ShoppingCarts_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnlineStores_StoreProductCategories_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnlineStores_StoreSellers_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Catalog_ProductItems_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Payments_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Catalog_ProductItemDetails_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnlineOrders_OrderItems_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnlineOrders_ShoppingCartItems_Core_EntityStatusConsts_EntityStatusId",
                        column: x => x.EntityStatusId,
                        principalTable: "Core_EntityStatusConsts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Catalog_Products_CountryOfOriginId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Core_Addresses_CountryId",
                table: "Core_Addresses",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_Core_Addresses_DistrictId",
                table: "Core_Addresses",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_Core_Addresses_ProvinceId",
                table: "Core_Addresses",
                column: "ProvinceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Core_EntityStatusConsts_EntityTypeId",
                table: "Core_EntityStatusConsts",
                column: "EntityTypeId");
